    ...
    function s(o, u) {
        ...
        module.exports = function _connectedCallback(_this) {
            ...
            _this.addEventListener('click', function (e) {
                if (_this._debug) console.log(_this.__name__ + "._onClick:", e);
        ...
        var Component = function (_Base) {
            ...
            _createClass(Component, [{
                ...
                get: function get() {
                    return ['sku-id', 'img', 'item-name', 'price', 'on-sale'];
                }
            }]);
        ...
        module.exports = function _createShadowDom(wrapper, ele) {
            if (ele.createShadowRoot) {
                ele._shadowRoot = ele.createShadowRoot();
                return ele._shadowRoot;
            }

            if (ele.attachShadow) {
                ele._shadowRoot = ele.attachShadow({ mode: wrapper.__is_open_root__ ? 'open' : 'close' });
                return ele._shadowRoot;
            }
        };
        ...
        module.exports = function _inhert_property(wrapper, ele) {
            ...
            if (ele.shadowRoot !== null) {
                ...
                wrapper.shadowRoot = ele._shadowRoot;
            }
